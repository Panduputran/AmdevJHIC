...
@section('content')
    ...
    <head>
        <meta name="description" content="YPSPIAI berkomitmen penuh untuk menjaga dan meningkatkan standar mutu di semua unit pendidikannya melalui manajemen profesional, pengembangan kurikulum yang relevan, dan penyediaan layanan pendidikan prima."/>
        <meta charset="UTF-8">
