...
<div class="main-content flex-1 p-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex flex-col items-center justify-center mb-6">
            <img src="{{ asset('storage/' . $testimonial->photo) }}" alt="Foto {{ $testimonial->name }}" class="w-48 h-48 object-cover rounded-full shadow-md">
        </div>
        ...
        <div class="mt-8 flex justify-end space-x-2">
            <a href="{{ route('admin.testimonials.edit', $testimonial->id) }}" class="bg-[#6CF600] text-white px-6 py-2 rounded-lg font-semibold hover:bg-[#5bd300] transition-colors duration-200">
