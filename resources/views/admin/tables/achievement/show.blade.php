...
<div class="main-content flex-1 p-6">
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mb-6">
            <img src="{{ asset('storage/' . $achievement->image) }}" alt="{{ $achievement->title }}" class="w-full h-80 object-cover rounded-lg shadow-md">
        </div>
        ...
        <div class="mt-8 flex justify-end space-x-2">
            <a href="{{ route('admin.achievements.edit', $achievement->id) }}" class="bg-[#6CF600] text-white px-6 py-2 rounded-lg font-semibold hover:bg-[#5bd300] transition-colors duration-200">
